...
const Library = () => {
    ...
    const selectInputArray = ["Team Name","Driver Name","Vehicle Name","Material Name","Units"]
        ...
        <div className=" flex flex-col ">
               {
                ...
                action === "Delete" ?   
                <>
                    <input className=" w-full my-2 py-2 px-3 placeholder:text-gray-600 rounded-full border outline-none  text-base  " placeholder="Select to delete" list="list"  type="text" ref={elementToDel}   />
                <datalist className=" hidden" id="list">
                    {
                        alreadyData.map((bankName,index)=>(
