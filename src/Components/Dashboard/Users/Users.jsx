...
const Users = () => {
  ...
  return (
<div className=" scrollbar-custom md:w-[700px] overflow-x-auto overflow-y-auto md:h-[290px]  rounded-md shadow-md border bg-white md:-mt-2 md:mr-5 mb-20 mt-4  md:mb-0 ">
