...
const Users = () => {
  ...
  return (
<div className=" md:ml-[350px] mb-20 md:mb-0 scrollbar-custom w-full  overflow-x-auto overflow-y-auto -mt-6 md:mt-0 md:h-[290px] rounded-md shadow-md border bg-white  ">
